...
@Service
public class UserRegistrationProcessor extends EventMailProcessor {

    protected UserRegistrationProcessor(MailConfirmationService mailConfirmationService, EmailRecognizer emailRecognizer) {
